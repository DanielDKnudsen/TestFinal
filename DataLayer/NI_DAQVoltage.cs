...
namespace DataLayer
{
     public class NI_DAQVoltage
    {
        ...
        /// </summary>
        public List<double> currentVoltageSeq { get; set; }
        ...
        public void dataToDataTable(NationalInstruments.AnalogWaveform<double>[] sourceArray)
        {
            ...
            currentVoltageSeq = currentVoltageSeqPrivate;
